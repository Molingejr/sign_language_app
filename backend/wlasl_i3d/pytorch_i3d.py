"""
Inception I3D for video (from dxli94/WLASL, originally from Kinetics I3D).
Compatible with WLASL pretrained rgb_imagenet.pt and nslt_* checkpoints.
"""
import torch
...
class InceptionI3d(nn.Module):
    """Inception-v1 I3D. Compatible with WLASL rgb_imagenet.pt and replace_logits(num_classes)."""
